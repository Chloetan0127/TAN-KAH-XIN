  ...
  <p><i class="fa fa-user-o fa-2x" aria-hidden="true"><br><br>Profile Setting</i></p>
        ...
        <h3>Please Fill-out All Fields</h3>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="nickname"  placeholder="Enter your New Nickname"  value="<?php echo $row['cusNickName']; ?>" />
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label>Phone</label>
            <input type="text" class="form-control" name="phone"  placeholder="Enter your New Phone Number" value="<?php echo $row['cusPhone']; ?>">
          </div>
          <div class="form-group">
            <input type="submit" name="editbtn" class="btn btn-primary" Value="Save">
            <a href="Login.php">Back&nbsp;<i class="fa fa-long-arrow-right"></i></a>
          </div>
        </form>
      </div>
